...
class Solution{
    ...
    void printPerm(int n)
    {
        ...
        int justless=sqrt(n+n); //nearest perfect square less than or equal to 2n
        justless=justless*justless;

        printPerm(justless-n-1); //just before swappable sequence
        for(int i=justless-n;i<=n;i++)
        {
            cout<<justless-i<<" ";
        }
    }
